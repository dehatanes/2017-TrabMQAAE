...
mids=barplot(mean.surfaces, main = "Médias de Pontos Ganhos com o 2º Saque", col = c("darkolivegreen3","salmon","chartreuse3","dodgerblue2"), names.arg = c("Carpet", "Clay","Grass","Hard"), ylim = c(0,80), ylab = "Número de Pontos", xlab = "Superfícies", space = 1)
